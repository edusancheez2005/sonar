...
• Optimal entry and exit point identification`
        ...
        {
          title: 'About Backtesting and Performance Claims',
          content: `**Important note on performance representations**\nSonar Tracker does not publish, advertise, or guarantee any specific historical, backtested, or live trading return. Any prior or third-party numbers you may have seen advertised for Orca AI \u2014 including average returns, maximum drawdowns, hit rates, Sharpe ratios, "outperforms major crypto indices", or "live performance since beta" \u2014 have been removed. They were unaudited, unverified, and not compliant with FCA COBS 4 (financial promotions) or the SEC Marketing Rule (17 CFR \u00a7 275.206(4)-1).\n\n**What we actually do**\nSonar Tracker provides automated, descriptive on-chain analytics: whale-wallet inflow/outflow aggregates, transaction classification, exchange-flow tracking, and price/social metric snapshots. Outputs are informational and educational only.\n\n**What we don't do**\nWe do not provide investment, legal, or tax advice. We do not connect to your exchange API, do not place trades, do not custody assets, do not manage portfolios, and do not set "risk parameters" or "position sizes" on your behalf. Any third-party content describing such features is incorrect.\n\n**Disclaimer**\nCryptocurrency trading carries a high risk of total loss. Past patterns do not predict future price. Consult a qualified, licensed financial adviser in your jurisdiction before making any investment decision. Sonar Tracker is not registered as an investment adviser, broker-dealer, or money manager in any jurisdiction.`
        }
      ]
    }
  },
