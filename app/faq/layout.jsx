const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'How often is data updated?', acceptedAnswer: { '@type': 'Answer', text: 'Whale transaction data updates every 15 minutes. Price data from CoinGecko refreshes every 15 minutes. News articles are ingested continuously in real-time. ORCA AI accesses the latest data for every query.' } },
