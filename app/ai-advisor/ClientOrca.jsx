                ...
                <MessageContent>
                  ...
                  {message.role === 'assistant' && message.data?.price && (
                    <div style={{
                      ...
                      {/* Legacy 24H + 7D price charts removed — superseded by the
                          interactive InlineChart panel emitted via the
                          <!-- orca:chart --> directive (see components/orca/inline/InlineChart.jsx). */}
